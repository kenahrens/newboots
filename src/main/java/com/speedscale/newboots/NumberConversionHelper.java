...
public final class NumberConversionHelper {
    ...
    private static final Logger LOGGER =
        LoggerFactory.getLogger(NumberConversionHelper.class);
    ...
    public static String convertNumberToWords(
        ...
        SOAPMessage soapResponse =
            soapConnection.call(soapRequest, SOAP_ENDPOINT);
    ...
    private static SOAPMessage createSOAPRequest(
        ...
        SOAPElement numberToWordsElem =
            soapBody.addChildElement("NumberToWords", "web");
        SOAPElement ubiNumElem =
            numberToWordsElem.addChildElement("ubiNum", "web");
        ubiNumElem.addTextNode(Integer.toString(number));
        soapMessage.saveChanges();
        return soapMessage;
    }

    private static String extractWordsFromResponse(
            final SOAPMessage soapResponse) throws Exception {
        ...
        org.w3c.dom.NodeList nodes =
            ((org.w3c.dom.Element) body).getElementsByTagNameNS(
