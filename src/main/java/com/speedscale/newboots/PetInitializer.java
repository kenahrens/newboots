...
public final class PetInitializer implements CommandLineRunner {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(PetInitializer.class);
  ...
  public void run(final String... args) throws Exception {
    ...
    if (petRepository.count() == 0) {
      ...
      List<Pet> samplePets =
          Arrays.asList(
              new Pet(
                  "Golden Retriever", "Dog", "Friendly and intelligent family dog", 12, "Large"),
              new Pet(
                  "Labrador Retriever",
                  "Dog",
              ...
              new Pet(
                  "Bearded Dragon", "Reptile", "Docile and easy-to-care-for lizard", 10, "Medium"));

      petRepository.saveAll(samplePets);
      LOGGER.info(
          "Successfully initialized pets table with {} " + "sample records", samplePets.size());
    } else {
      LOGGER.info("Pets table already contains data, " + "skipping initialization");
    }
  }
}
