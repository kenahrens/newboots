...
/**
 * Represents a location with ID, latitude, longitude, MAC address, and IPv4. This class is not
...
public final class Location {
   ...
   */
  public Location(
      final String id, final double lat, final double lon, final String mac, final String ip) {
    this.locationID = id;
    this.latitude = lat;
    this.longitude = lon;
    this.macAddress = mac;
